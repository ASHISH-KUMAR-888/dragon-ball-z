  ...
  return (
    <>
      <div className="bg-white h-[70px] w-screen flex justify-between items-center pl-[30px] pr-[20px] md:px-[30px]">
        <img className="h-full" src="images/logo.webp" alt="Logo" />
      ...
      <div className="mt-[20px] px-[20px] flex flex-col justify-between items-center md:px-[10%] md:mt-[50px]">
        <img src="images/title.webp" alt="Title Image" />
        <p className="text-[#FAC02E] font-black tracking-[1.5px] text-[5vw] md:text-[3vw]">
          The Dragon Ball API
        </p>
      </div>
    </>
